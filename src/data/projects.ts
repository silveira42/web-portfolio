...
export const projects: Project[] = [
	{
		...
		content: {
			en: {
				title: 'Pong',
				description: 'A classic Pong game implementation built with React and TypeScript. Features smooth animations, score tracking, and responsive controls for an engaging retro gaming experience.',
				learnings: [
					'State Management',
					'Component Logic',
					'Event Handling',
	...
	},
	{
		...
		content: {
			en: {
				title: 'Hangman Game',
				description: 'A fun and interactive hangman game developed to practice React with TypeScript. Features random word selection, visual feedback, and game state management.',
				learnings: [
					'State Management',
					'Component Logic',
					'Event Handling',
	...
	},
	{
		...
		content: {
			en: {
				...
				description: 'A virtual store API that uses Apache Kafka for communication between microservices.',
				learnings: [
					'Microservices',
					'Message Queues',
					'API Design',
	...
	},
	{
		...
		content: {
			en: {
				title: 'IRIS Demo',
				description: 'In this project I demonstrate the use of Intersystems® IRIS as an integration platform between an ERP and a sales website.',
				learnings: [
					'System Integration',
					'Database Design',
					'API Development',
